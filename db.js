...
const pool = mysql.createPool({
    host: process.env.DB_HOST ? process.env.DB_HOST : 'localhost',     // Host de la base de datos (ej. 'localhost')
    user: process.env.DB_USER ? process.env.DB_USER : 'root',     // Usuario de la base de datos
    password: process.env.DB_PASSWORD ? process.env.DB_PASSWORD : 'reSUlu43ra', // Contraseña del usuario de la base de datos
    database: process.env.DB_NAME ? process.env.DB_NAME : 'mpd_artesanos',   // Nombre de la base de datos
